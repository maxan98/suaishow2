    ...
    <div class="container">
        <div class="row row-bottom-padded-lg" id="about-us">
            ...
            <div class="col-md-4 to-animate">
                <h2>Привет, ${name}!</h2>
                <p>Твой аккаунт был успешно зарегистрирован и готов к работе!</p>
                <p>Если готов приступить - можешь залогиниться прямо сейчас, используя кнопку ниже!</p>
                <p><a href="/cookie" class="btn btn-primary" >Войти</a></p>
